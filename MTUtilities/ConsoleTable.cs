...
namespace MTUtilities
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = MTUtilities.Format.Default)
        {
            switch (format)
            {
                case MTUtilities.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case MTUtilities.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case MTUtilities.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case MTUtilities.Format.Minimal:
